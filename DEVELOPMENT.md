...
# Developing noyalib-serde-yaml

noyalib-serde-yaml is a satellite of the [noyalib](https://github.com/sebastienrousseau/noyalib)
...
```bash
git clone https://github.com/sebastienrousseau/noyalib-serde-yaml
cd noyalib-serde-yaml
cargo test
```
