...
serde_yaml = { package = "noyalib-serde-yaml", version = "=0.0.46" }
```
...
enforcement: [`docs/CONTRACT.md`](CONTRACT.md).
...
- **Migration guide** — [`docs/MIGRATION.md`](MIGRATION.md), and the
  core repository's
...
- **Behavioural contract** — [`docs/CONTRACT.md`](CONTRACT.md).
